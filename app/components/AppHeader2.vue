  ...
  <div class="sticky top-0 z-50 bg-gray-900">
    ...
    >
      ...
      <el-popover-group class="hidden lg:flex lg:gap-x-12">
          ...
          >
            <div class="p-4">
              ...
              >
                ...
                <div class="flex-auto">
                  <a class="block font-semibold text-white">
                    Analytics
        ...
        <a class="text-sm/6 font-semibold text-white"
          ><NuxtLink to="/about">About</NuxtLink></a
        >

        <a class="text-sm/6 font-semibold text-white"
          ><NuxtLink to="/blog">Blog</NuxtLink></a
        >
        <a class="text-sm/6 font-semibold text-white"
          ><NuxtLink to="/contact">Contact</NuxtLink></a
        >
      </el-popover-group>
